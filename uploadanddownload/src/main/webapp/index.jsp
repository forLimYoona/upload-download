...
<body>
  <div>
       <a href="loginAndLogout/tologin" >log in</a>  &nbsp;
       <a href="loginAndLogout/tologup" >log up</a>  &nbsp;
       <a href="loginAndLogout/autoLogin" >我的主页</a>&nbsp;
       <a href="${pageContext.request.contextPath}/help.jsp">帮助</a> 
  </div> 
  <center>
        <div style="font-size: 25px ; padding-right: 80px ;padding-top: 200px">Log in to upload files on iCloud !</div>
